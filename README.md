...
[![Deploy to Azure](https://aka.ms/deploytoazurebutton)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FNealAnalyticsLLC%2FEnterprise-Data-Warehouse-AzureSynapse%2Fmain%2Fdeployment%2FARM%2520templates%2Fjson%2Fmain.json)
...
This parameter is for the name of the project that you want to give(can be an abbreviation too). Replace **<project-name>** with the name of project you want.
	...
	**NOTE**: The parameters **projectName** value should only have lowercase letters and numbers, no special characters allowed and shouldn't be more than 5-10 letters.
...
**dev** for Development environment, **uat** for testing environment and **prod** for Production environment.
	...
	**NOTE**: The parameters **Environment** value should only have lowercase letters and numbers, no special characters allowed and shouldn't be more than 5-10 letters.
...
This parameter is for the email-id of the SQL Server Admin that is required for setting up Azure Active Directory login for SQL Server. Replace **<sql-server-admin-emailid>** with the email-id of the person  whose SID you have mention above that you want to keep as admin.
...
**ER Diagram –**
![MetaData Tables](./images/MetaData%20Tables.png)
...
2.	New screen will pop-up to fill server, database, Data Connectivity mode and SQL query which is optional. Fill server and database name. 
	...
	![sql server database](./images/sql%20server%20database.png)
...
[Code for Pipeline to pause or resume Synapse](./Code%20for%20Pipeline%20to%20pause%20or%20resume%20Synapse#L3)
