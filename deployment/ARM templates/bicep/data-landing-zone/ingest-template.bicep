...
param servers_datawarehouse_name string
...
resource dataFactories_adf_name_default_Synapse 'Microsoft.DataFactory/factories/managedVirtualNetworks/managedPrivateEndpoints@2018-06-01' = {
  parent: dataFactories_adf_vnet
  name: servers_datawarehouse_name
  properties: {
    groupId: 'sqlServer'
    privateLinkResourceId: '/subscriptions/${subscriptionId}/resourceGroups/${resourceGroup().name}/providers/Microsoft.Sql/servers/${servers_datawarehouse_name}'
  }
